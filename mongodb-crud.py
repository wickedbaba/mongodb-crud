...
query_single = {"balance":100}

result = accounts_collection.delete_one(query_single)
print("Documents deleted:" + str(result.deleted_count) )

query_multiple = {"$eq":{"min_balance":50}}

result = accounts_collection.delete_many(query_multiple)
print("Documents deleted:" + str(result.deleted_count) )
